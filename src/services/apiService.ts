...
const APIs = [
  {
    ...
    extractFact: (data: any) => data.fact
  },
  {
    name: 'Dog Facts',
    url: 'https://dog-api.kinduff.com/api/facts',
    extractFact: (data: any) => data.facts[0]
  },
  {
    name: 'Number Facts',
    url: 'http://numbersapi.com/random',
    extractFact: (data: any) => data 
  },
  {
    name: 'Random Facts',
    url: 'https://uselessfacts.jsph.pl/random.json?language=en',
    extractFact: (data: any) => data.text
  }
];

const selectedAPI = APIs[0]; // Using Cat Facts API by default
